...
# Test 
simulations <- simulation('regression', R=6)
...
simu <- simulation('regression', R=10)$data
...
# test1 <- which(TentativeRoughFix(test0)$finalDecision=='Confirmed')
# test1
# length(intersect(test1, seq(1,30)))/30
# 
# ## JANITZA ##
...
# test3 <- PIMP(simu[[1]][[3]]$x, simu[[1]][[3]]$y, RF, S = 50)
# test4 <- PimpTest(test3, para = T)
